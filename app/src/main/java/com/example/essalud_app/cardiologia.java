...
public class cardiologia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttoncs).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void Alerta3() {
        AlertDialog.Builder builder = new AlertDialog.Builder(cardiologia.this);
        ...
        btnReintentar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(cardiologia.this, "Cancelado", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        ...
        btnAceptar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cardiologia.this, Resumen_cita.class);
